namespace JrIntercepter.Net
{
    ...
    internal class DNSResolver
    {
        ...
        private static int MSEC_DNS_CACHE_LIFETIME =  0x249f0;
        ...
        private static IPAddress[] trimAddressList(IPAddress[] arrResult)
        {
            ...
            {
                if (!list.Contains(arrResult[i]) && (Config.EnableIPv6 || (arrResult[i].AddressFamily == AddressFamily.InterNetwork)))
                {
