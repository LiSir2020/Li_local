...
public class MyClass3 extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor v0;
        switch(MyClass3.mMatcher.match(uri)) {
            case 1: {
                v0 = this.db.query("user", projection, selection, selectionArgs, null, null, sortOrder);
                v0.setNotificationUri(this.getContext().getContentResolver(), uri);
                return v0;
            }
            case 2: {
                v0 = this.db.query("user", projection, "_id=" + uri.getLastPathSegment(), selectionArgs, null, null, sortOrder);
                v0.setNotificationUri(this.getContext().getContentResolver(), uri);
                return v0;
            }
            default: {
