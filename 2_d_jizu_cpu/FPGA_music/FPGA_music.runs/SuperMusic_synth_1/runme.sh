...
HD_PWD='E:/vivado-works/FPGA_music/FPGA_music.runs/SuperMusic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperMusic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SuperMusic.tcl
